...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const result = await query(
    `UPDATE classes SET title=$1, category=$2, subcategory=$3, price=$4, level=$5, duration=$6, date=$7, time=$8, spots=$9, image=$10, instructor=$11, room=$12, room_maps_url=$13, recurring=$14, description=$15, location_type=$16, location_types=$17, price_location=$18, price_online=$19, price_residence=$20, instructor_background=$21
    ...
    [data.title, data.category, data.subcategory || null, data.price, data.level, duration,
     ...
     data.price_residence || null, data.instructor_background || null, id, studioId]
  )
