...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const result = await query(
    `UPDATE classes SET title=$1, category=$2, price=$3, level=$4, duration=$5, date=$6, time=$7, spots=$8, distance=$9, image=$10, instructor=$11, room=$12, room_maps_url=$13, recurring=$14, description=$15, location_type=$16, location_types=$17, price_location=$18, price_online=$19, price_residence=$20
     WHERE id=$21 AND studio_user_id=$22 RETURNING *`,
